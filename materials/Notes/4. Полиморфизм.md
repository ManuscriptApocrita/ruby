4. Полиморфизм
========================
Полиморфизм (свойство объектов с одинаковой спецификацией иметь различную реализацию).
...
class BMW < Auto #Тут находится пример полиморфизма, то есть изменение формы реализации. От абстрактного к конкретному
